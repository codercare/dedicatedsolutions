	...
	<div class="wrapper">
		<div class="row">
			...
			<div id="message_box_404" class="col-md-6 u-txt-center align-middle">	
				<h1 class="section-header__title"><?php esc_html_e( '404', 'dedicatedsolutions' ); ?></h1>
				<h3 class="section-header__Orangesub-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'dedicatedsolutions' ); ?></h3>
				<h2 class="section-header__title"><?php esc_html_e( 'Sorry, but nothing exists here.', 'dedicatedsolutions' ); ?></h2>	
				<br/>

...
<section id="fullpage">
	<section id="large-banner" class="large-banner page-section section" style="background-image: url(<?php echo $banner_image_url; ?>);">
	...
	<section class="client-showcase section fp-auto-height">
			<div class="wrapper">
	...
	?>
	<section id="datacenter-location" class="datacenter-location page-section section" style="<?php echo $data_center_bg_image_url; ?>">
		<div class="wrapper">
	...
	<section class="datacenter section fp-auto-height">
		<div class="wrapper">
	...
	<section id="server-features" class="server-features page-section section">
		<div class="wrapper wrapper--medium">
			<header class="section-header u-txt-center">
	...
	<section class="features-highlight section fp-auto-height">
		<div class="wrapper">
			<div class="rows">
			<?php
			// Check rows exists.

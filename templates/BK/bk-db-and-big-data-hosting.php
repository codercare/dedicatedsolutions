<?php
/*  Database & Big Data Server Hosting */ 
...
<main id="fullpage" class="site-main">
		...
		<section class="db-srver-hosting-navTabs">
			<div class="navTabs-pills-wrap">
				<div class="wrapper">
					<ul class="nav nav-pills" id="db-bd-hosting-pills-tab" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<a class="nav-link active" id="ms-sql-tab" data-toggle="pill" href="#ms-sql" role="tab" aria-controls="ms-sql" aria-selected="true">Microsoft SQL Server</a>
						</li>
						<li class="nav-item" role="presentation">
							<a class="nav-link" id="postgresql-tab" data-toggle="pill" href="#postgresql" role="tab" aria-controls="postgresql" aria-selected="false">PostgreSQL</a>
						</li>
						<li class="nav-item" role="presentation">
			...
			<div class="wrapper">
				<div class="tab-content" id="bmc-pills-tabContent">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="server-hosting-content">
									...
									<p class="section-header__sub-title">We render best in the industry support for Microsoft SQL Server configuration and maintenance. SQL is capable of improving performance significantly while enhancing operational efficiencies in order to save time and money. DedicatedSolutions is serving thousands of customers, whose server is running SQL, with the help of our dedicated and highly experienced resources. You can hire our specialists for your advanced SQL requirements.</p>
									<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/mysql-logo.png'; ?>" alt="mysql-logo">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="server-hosting-support-list">
									<h4 class="section-header__Orangesub-title">Microsoft SQl Server support for customers :</h4>
									<ul>
										<li>Installation</li>
										<li>Configuration</li>
										<li>Troubleshooting</li>
										<li>Convenient monthly licensing</li>
										<li>Live database backup (optional)</li>
										<li>Cost effective maintenance plans</li>
										<li>Performance customizaation based on environment analysis</li>
										<li>Environment monitoring and statistics preparation</li>
										<li>24X7 suport of senior resources</li>
									</ul>
								</div>
							</div>
						</div>     
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="server-hosting-content">
									<h4 class="section-header__Orangesub-title">Tell Us What You Need & We BuildD It</h4>
									<p class="section-header__sub-title">We render best in the industry support for Microsoft SQL Server configuration and maintenance. SQL is capable of improving performance significantly while enhancing operational efficiencies in order to save time and money. DedicatedSolutions is serving thousands of customers, whose server is running SQL, with the help of our dedicated and highly experienced resources. You can hire our specialists for your advanced SQL requirements.</p>
									<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/oracle-db-logo.png'; ?>" alt="oracle-db-logo">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="server-hosting-support-list">
					...
					<div class="tab-pane fade show active" id="ms-sql" role="tabpanel" aria-labelledby="ms-sql-tab">
						<h2 class="section-header__title">Microsoft SQL Server</h2>
						<div class="row">
							<div class="col-lg-6">
								<div class="server-hosting-content">
									<h4 class="section-header__Orangesub-title">Tell Us What You Need & We BuildD It</h4>
									<p class="section-header__sub-title">We render best in the industry support for Microsoft SQL Server configuration and maintenance. SQL is capable of improving performance significantly while enhancing operational efficiencies in order to save time and money. DedicatedSolutions is serving thousands of customers, whose server is running SQL, with the help of our dedicated and highly experienced resources. You can hire our specialists for your advanced SQL requirements.</p>
									<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/ms-sql-server-logo.png'; ?>" alt="ms-sql-server-logo">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="server-hosting-support-list">
					...
					<div class="tab-pane fade" id="postgresql" role="tabpanel" aria-labelledby="postgresql-tab">
						<h2 class="section-header__title">PostgreSQL</h2>
						<div class="row">
							<div class="col-lg-6">
								<div class="server-hosting-content">
									<h4 class="section-header__Orangesub-title">Tell Us What You Need & We BuildD It</h4>
									<p class="section-header__sub-title">We render best in the industry support for Microsoft SQL Server configuration and maintenance. SQL is capable of improving performance significantly while enhancing operational efficiencies in order to save time and money. DedicatedSolutions is serving thousands of customers, whose server is running SQL, with the help of our dedicated and highly experienced resources. You can hire our specialists for your advanced SQL requirements.</p>
									<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/postgresql-logo.png'; ?>" alt="postgresql-logo">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="server-hosting-support-list">
					...
					<div class="tab-pane fade" id="nosql" role="tabpanel" aria-labelledby="nosql-tab">
						<h2 class="section-header__title">NoSQL</h2>
						<div class="row">
							<div class="col-lg-6">
								<div class="server-hosting-content">
									<h4 class="section-header__Orangesub-title">Tell Us What You Need & We BuildD It</h4>
	...
	<section class="ss-and-db-cluster section" style="background-image:url('<?php echo get_template_directory_uri() . '/dist/assets/images/ss-and-db-cluster-bg.jpg'; ?>')">
		<div class="wrapper">
			 <div class="section-header u-txt-center">
				<h2 class="section-header__title">Single Server & Database Clusters</h2>
				<span class="section-header__decoration-element--dark"></span>
				<h4 class="section-header__Orangesub-title">Our default settings cannot be always a good fit for your requirements. This is why we have made our Single server as well as Data base cluster hosting architectures highly customizable.</h4>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="ss-db-cluster-block">
						<figure class="thumbnail-img">
							<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/server-info-img1.png'; ?>" alt="server-info-img1">
						</figure>
						<h2>Single Database Server</h2>
						<div class="ss-db-cluster-content">
							<p>The single Database Server is a perfect match, if your web and database use are not that heavy. This architecture is presented to you while keeping performance in mind. Single Database Server is capable of hosting Web servers, website scripts, databases, and all other related files.</p>
							<p>Hosting different elements on different folders within the server is the best method in order to improve redundancy. Use Redundant Array of Independent Disks (RAID) technology for the best hosting experience.</p>
						</div>
						...
						<a href="" class="btn--outline-dark">Learn More</a>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="ss-db-cluster-block">
						<figure class="thumbnail-img">
							<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/server-info-img2.png'; ?>" alt="server-info-img2">
						</figure>
						<h2>Clusters Database Server</h2>
						<div class="ss-db-cluster-content">
							<p>Cluster Database Server -a high availability solution- provides redundancy improvement, scalability, and high bandwidth for your high web and database usage requirements without compromising performance. A dedicated server is allocated solely for the purpose of hosting your database and it does not allow running web server or any other services. This infrastructure allocates different hardware for running web server and other services.</p>
							<p>Web, database, and file storage are properly segmented in Cluster Database Server in order to improve the performance while making the whole infrastructure simple.</p>
						</div>
						<div class="cluster-options-list">
							<ul>
								<li>
								...
								<li>
									<span class="icon-txt-item">
										...
										Redundant serverss for high availability
									</span>
								</li>
								<li>
									<span class="icon-txt-item">
	...
	<section class="hadoop-data-server section">
		<div class="wrapper">
			<div class="section-header u-txt-center">
				<h2 class="section-header__title">Hadoop Plus Big Data Server Equals Speed</h2>
				<span class="section-header__decoration-element"></span>
				<h4 class="section-header__Orangesub-title">Apache Hadoop is a java based open source framework for scalable, reliable, and distributed storage and processing of big data that are available on computer clusters. This framework allows scaling up from single server to many servers which are able to offer local computation and storage.</h4>
			</div>
							...
							<div class="hadoop-server-feat--block__icon">
								<svg id="dedicated-server" xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 69.994 69.994">
									...
									<g id="Group_3189" data-name="Group 3189" transform="translate(51.001 5)">
										...
										<rect id="Rectangle_1611" data-name="Rectangle 1611" width="3" height="2"/>
										</g>
									</g>
									<g id="Group_3191" data-name="Group 3191" transform="translate(55.999 5)">
										...
										<rect id="Rectangle_1612" data-name="Rectangle 1612" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3193" data-name="Group 3193" transform="translate(60.999 5)">
										...
										<rect id="Rectangle_1613" data-name="Rectangle 1613" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3195" data-name="Group 3195" transform="translate(47.001 5)">
										...
										<rect id="Rectangle_1614" data-name="Rectangle 1614" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3197" data-name="Group 3197" transform="translate(42 5)">
										...
										<rect id="Rectangle_1615" data-name="Rectangle 1615" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3199" data-name="Group 3199" transform="translate(51.001 9.001)">
										...
										<rect id="Rectangle_1616" data-name="Rectangle 1616" width="3" height="3"/>
										</g>
									</g>
									<g id="Group_3201" data-name="Group 3201" transform="translate(55.999 9.001)">
										...
										<rect id="Rectangle_1617" data-name="Rectangle 1617" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3203" data-name="Group 3203" transform="translate(60.999 9.001)">
										...
										<rect id="Rectangle_1618" data-name="Rectangle 1618" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3205" data-name="Group 3205" transform="translate(47.001 9.001)">
										...
										<rect id="Rectangle_1619" data-name="Rectangle 1619" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3207" data-name="Group 3207" transform="translate(42 9.001)">
										...
										<rect id="Rectangle_1620" data-name="Rectangle 1620" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3209" data-name="Group 3209" transform="translate(51.001 14)">
										...
										<rect id="Rectangle_1621" data-name="Rectangle 1621" width="3" height="2"/>
										</g>
									</g>
									<g id="Group_3211" data-name="Group 3211" transform="translate(55.999 14)">
										...
										<rect id="Rectangle_1622" data-name="Rectangle 1622" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3213" data-name="Group 3213" transform="translate(60.999 14)">
										...
										<rect id="Rectangle_1623" data-name="Rectangle 1623" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3215" data-name="Group 3215" transform="translate(47.001 14)">
										...
										<rect id="Rectangle_1624" data-name="Rectangle 1624" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3217" data-name="Group 3217" transform="translate(42 14)">
										...
										<rect id="Rectangle_1625" data-name="Rectangle 1625" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3219" data-name="Group 3219" transform="translate(6.984 31.496)">
										<g id="Group_3218" data-name="Group 3218">
										<path id="Path_12857" data-name="Path 12857" d="M78.24,218.328H54.694a3.5,3.5,0,1,0,0,2.333H78.24a1.167,1.167,0,1,0,0-2.333Zm-26.831,2.333a1.167,1.167,0,1,1,1.167-1.167A1.167,1.167,0,0,1,51.409,220.661Z" transform="translate(-47.894 -215.994)"/>
										</g>
									</g>
									<g id="Group_3221" data-name="Group 3221" transform="translate(51.001 29)">
										...
										<rect id="Rectangle_1626" data-name="Rectangle 1626" width="3" height="2"/>
										</g>
									</g>
									<g id="Group_3223" data-name="Group 3223" transform="translate(55.999 29)">
										...
										<rect id="Rectangle_1627" data-name="Rectangle 1627" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3225" data-name="Group 3225" transform="translate(60.999 29)">
										...
										<rect id="Rectangle_1628" data-name="Rectangle 1628" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3227" data-name="Group 3227" transform="translate(47.001 29)">
										...
										<rect id="Rectangle_1629" data-name="Rectangle 1629" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3229" data-name="Group 3229" transform="translate(42 29)">
										...
										<rect id="Rectangle_1630" data-name="Rectangle 1630" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3231" data-name="Group 3231" transform="translate(51.001 33.999)">
										...
										<rect id="Rectangle_1631" data-name="Rectangle 1631" width="3" height="2"/>
										</g>
									</g>
									...
									<g id="Group_3232" data-name="Group 3232" transform="translate(0 0)">
										<rect id="Rectangle_1632" data-name="Rectangle 1632" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3235" data-name="Group 3235" transform="translate(60.999 33.999)">
										...
										<rect id="Rectangle_1633" data-name="Rectangle 1633" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3237" data-name="Group 3237" transform="translate(47.001 33.999)">
										...
										<rect id="Rectangle_1634" data-name="Rectangle 1634" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3239" data-name="Group 3239" transform="translate(42 33.999)">
										...
										<rect id="Rectangle_1635" data-name="Rectangle 1635" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3241" data-name="Group 3241" transform="translate(51.001 38)">
										...
										<rect id="Rectangle_1636" data-name="Rectangle 1636" width="3" height="3"/>
										</g>
									</g>
									<g id="Group_3243" data-name="Group 3243" transform="translate(55.999 38)">
										...
										<rect id="Rectangle_1637" data-name="Rectangle 1637" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3245" data-name="Group 3245" transform="translate(60.999 38)">
										...
										<rect id="Rectangle_1638" data-name="Rectangle 1638" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3247" data-name="Group 3247" transform="translate(47.001 38)">
										...
										<rect id="Rectangle_1639" data-name="Rectangle 1639" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3249" data-name="Group 3249" transform="translate(42 38)">
										...
										<rect id="Rectangle_1640" data-name="Rectangle 1640" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3251" data-name="Group 3251" transform="translate(6.984 55.994)">
										<g id="Group_3250" data-name="Group 3250">
										<path id="Path_12858" data-name="Path 12858" d="M78.24,386.328H54.694a3.5,3.5,0,1,0,0,2.333H78.24a1.167,1.167,0,1,0,0-2.333Zm-26.831,2.333a1.167,1.167,0,1,1,1.167-1.167A1.167,1.167,0,0,1,51.409,388.661Z" transform="translate(-47.894 -383.994)"/>
										</g>
									</g>
									<g id="Group_3253" data-name="Group 3253" transform="translate(51.001 54)">
										...
										<rect id="Rectangle_1641" data-name="Rectangle 1641" width="3" height="2"/>
										</g>
									</g>
									<g id="Group_3255" data-name="Group 3255" transform="translate(55.999 54)">
										...
										<rect id="Rectangle_1642" data-name="Rectangle 1642" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3257" data-name="Group 3257" transform="translate(60.999 54)">
										...
										<rect id="Rectangle_1643" data-name="Rectangle 1643" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3259" data-name="Group 3259" transform="translate(47.001 54)">
										...
										<rect id="Rectangle_1644" data-name="Rectangle 1644" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3261" data-name="Group 3261" transform="translate(42 54)">
										...
										<rect id="Rectangle_1645" data-name="Rectangle 1645" width="2" height="2"/>
										</g>
									</g>
									<g id="Group_3263" data-name="Group 3263" transform="translate(51.001 58)">
										...
										<rect id="Rectangle_1646" data-name="Rectangle 1646" width="3" height="3"/>
										</g>
									</g>
									<g id="Group_3265" data-name="Group 3265" transform="translate(55.999 58)">
										...
										<rect id="Rectangle_1647" data-name="Rectangle 1647" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3267" data-name="Group 3267" transform="translate(60.999 58)">
										...
										<rect id="Rectangle_1648" data-name="Rectangle 1648" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3269" data-name="Group 3269" transform="translate(47.001 58)">
										...
										<rect id="Rectangle_1649" data-name="Rectangle 1649" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3271" data-name="Group 3271" transform="translate(42 58)">
										...
										<rect id="Rectangle_1650" data-name="Rectangle 1650" width="2" height="3"/>
										</g>
									</g>
									<g id="Group_3273" data-name="Group 3273" transform="translate(51.001 63)">
										...
										<rect id="Rectangle_1651" data-name="Rectangle 1651" width="3" height="2" transform="translate(0 0.001)"/>
										</g>
									</g>
									<g id="Group_3275" data-name="Group 3275" transform="translate(55.999 63)">
										...
										<rect id="Rectangle_1652" data-name="Rectangle 1652" width="2" height="2" transform="translate(0 0.001)"/>
										</g>
									</g>
									<g id="Group_3277" data-name="Group 3277" transform="translate(60.999 63)">
										...
										<rect id="Rectangle_1653" data-name="Rectangle 1653" width="2" height="2" transform="translate(0 0.001)"/>
										</g>
									</g>
									<g id="Group_3279" data-name="Group 3279" transform="translate(47.001 63)">
										...
										<rect id="Rectangle_1654" data-name="Rectangle 1654" width="2" height="2" transform="translate(0 0.001)"/>
										</g>
									</g>
									<g id="Group_3281" data-name="Group 3281" transform="translate(42 63)">
										...
										<rect id="Rectangle_1655" data-name="Rectangle 1655" width="2" height="2" transform="translate(0 0.001)"/>
										</g>
									</g>
								</svg>
							</div>
							<h2>Dedicated Server Big Data</h2>
							<p>We manage private cloud environment and maintain your big data infrastructure to leverage the full efficiency of the dedicated server so that you can focus on your core business.</p>
						</div>
					</div>
				</div>
				<a href="" class="btn--orange">Learn more about Hadoop <i class="fas fa-arrow-right"></i></a>
			</div>
		</div>
	</section>
</main>

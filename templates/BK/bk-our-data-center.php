	...
	<section class="page-banner our-dc-banner section" style="background-image:url('<?php echo get_template_directory_uri() . '/dist/assets/images/speed-test-bg.jpg'; ?>')">
		<div class="wrapper">
			<div class="page-banner-content">
				<h1 class="large-banner__heading">Our Data Centers</h1>
				<p>Multiple Data Centers = Faster</p>
				<div class="dc-address-block-wrap">
					<div class="row align-items-end">
						<div class="col-md-3">
							<div class="dc-address-block dc-add-1">
								<h3>Columbus, Ohio <span>IP: 67.219.144.250</span></h3>
								<a href="" class="btn--orange">100MB <i class="fas fa-download"></i></a>
								<a href="" class="btn--white">1GB <i class="fas fa-download"></i></a>
							</div>
						</div>
						<div class="col-md-6">
							<div class="dc-address-block dc-add-2">
								<h3>Data Centers in US <i><img src="<?php echo get_template_directory_uri() . '/dist/assets/images/us-flag.png'; ?>" alt="us-flag"></i></h3>
								<p>Available Data Centers in this Locations</p>
							</div>
						</div>
						<div class="col-md-3 text-md-right">
							<div class="dc-address-block dc-add-3">
								<h3>Dallas, Texas <span>IP: 67.219.148.250</span></h3>
								<a href="" class="btn--orange">100MB <i class="fas fa-download"></i></a>
								<a href="" class="btn--white">1GB <i class="fas fa-download"></i></a>
							</div>
						</div>
				...
				<div class="dc-location-map">
					<div class="thumbnail-img">
						<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/map_network.png'; ?>" alt="map-network">
					</div>
					<a href="" class="btn--orange">See Our Network Ping Times From 90 Locations Worldwide!</a>
				</div>
			</div>
		</div>
	</section> 
	<section class="data-center-comparision page-section section">
		<div class="wrapper">
			<div class="section-header u-txt-center">
				<h2 class="section-header__title">Data Center Quick Comparision</h2>
			</div>
			<div class="dc-comarision-table">
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>HIPAA, PCI and IRS 1075 compliance upon Request</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
						</tr>
						<tr>
							<td>150-seat emergency workspace</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="dash"></span></td>
						</tr>
						<tr>
							<td>24x7x365 on-site security, monitoring and support</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
						</tr>
						<tr>
							<td>Up to 64kW per rack standard</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
						</tr>
						<tr>
							<td>Industry-leading power density</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="dash"></span></td>
						</tr>
						<tr>
							<td>100% Nature Cooled</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="dash"></span></td>
						</tr>
						<tr>
							<td>Fully redundant 2(N+1) power</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
						</tr>
						<tr>
							<td>Managed BGP IP (IPv4 and IPv6)</td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
							<td><span class="check-yes"><i class="fas fa-check"></i></span></td>
						</tr>
					</tbody>
		...
		<div class="wrapper">
				...
				<div class="row">
					<div class="col-md-3">
						<figure class="thumbnail-img">
							<img src="<?php echo get_template_directory_uri() . '/dist/assets/images/ohio-map.png'; ?>" alt="ohio-map">
						</figure>
					</div>
					<div class="col-md-9">
						<div class="dc-detail-block">
							<h2 class="section-header__title">Datacenter Columbus, Ohio (OH) Details</h2>
							<h3>Head Quarter</h3>
			...
			<div class="dc-detail-block-wrap">
				<div class="row">
					...
					<div class="col-md-9">
						<div class="dc-detail-block">
							<h2 class="section-header__title">Dallas, Texas(TS)</h2>
							<h3>Head Quarter</h3>
							<h4>Precision Environment</h4>
							<ul class="check-list-group orange-check">

...
?>
	<section class="page-banner our-dc-banner section" style="background-image:url('<?php echo get_template_directory_uri() . '/dist/assets/images/speed-test-bg.jpg'; ?>')">
		<div class="wrapper">
			<div class="page-banner-content  ">
				<h1 class="large-banner__heading wow fadeInLeft"><?php the_field( 'our_data_center_page_title' ); ?></h1>
				<p class="wow fadeInLeft"><?php the_field( 'our_data_center_page_sub_title' ); ?></p>
				<div class="dc-address-block-wrap">
					<div class="row align-items-end">
						...
						<div class="col-md-3 text-md-right  wow fadeInRightBig">
				...
				<div class="dc-location-map wow fadeInUp">
					...
					<a href="<?php the_field( 'see_network_ping_time_button_link' ); ?>" class="btn--orange wow pulse infinite"><?php the_field( 'see_network_ping_time_button' ); ?></a>
				</div>
			</div>
		</div>
	</section> 
	<section class="data-center-comparision section">
		<div class="wrapper">
			...
			<div class="dc-comarision-table wow fadeInUp">
		...
		<div class="wrapper">
			...
			<div class="dc-detail-block-wrap">
				<div class="row">
					...
					<div class="col-md-9  wow fadeInLeftBig">
						<div class="dc-detail-block">
